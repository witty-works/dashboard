...
interface GuidelinesInterface
{
    ...
    const GENDERED_ROLES_FORMAT = ['binary_gender' => 'guidelines.binary_gender',  'none' => 'guidelines.none'];
    const GENDERED_ROLES_FORMAT_ADVANCED = ['inclusive_gender' => 'guidelines.inclusive_gender', 'both' => 'guidelines.both'];
    ...
    const DISABLED_CATEGORIES = ['orthography'];
