...
',
    'if_you_did_not_expect' => 'Wir wünschen einen zauberhaften Tag,',
    'woops' => 'hoppla',
    ...
    'invitation_email_welcome' => 'Witty hilft dir, inklusiv zu schreiben, diverse Talente anzuziehen und eine Kultur zu schaffen, in der sich alle zugehörig fühlen.',
    ...
    'team_invitation_subject' => ':name hat dich eingeladen, deinem Team auf Witty beizutreten',
...
<a href="https://www.witty.works/en/help/wittys-help-center">Hier</a> findest du Antworten auf viele Fragen. Du erreichst uns unter <a href="mailto:support@witty.works">support@witty.works</a>. Wir sind hier, um dir bei jedem Schritt auf dem Weg zu helfen.',
    'have_a_great_day' => 'Dein Witty-Team',
    ...
    'upgrade_title' => 'Bereit, ein Abo abzuschließen?',
...
Bitte dein*e Team-Administrator*in <a href="mailto::email">:name</a>, auf <a href="https://www.witty.works/pricing" target="_blank">Witty Teams</a> zu wechseln.',
    ...
    'title_bar_chart_alternative' => 'Akzeptiert',
    ...
    'alternative_doughnut_chart_event_ratio' => 'Akzeptiert',
...
<a href="https://dashboard.witty.works/team/language/dictionary" target="_blank">Probiers gleich aus!</a>',
    'corporate_rules_none_opened' => 'Du hast Wörter in <a href="https://dashboard.witty.works/team/language/dictionary" target="_blank">dein Team-Wörterbuch</a> eingetragen, aber während dem Zeitbereich hat niemand aus deinem Team diese Begriffe verwendet.',
...
<a href="https://dashboard.witty.works/user/language/dictionary" target="_blank">Probiers gleich aus!</a>',
    'corporate_rules_none_opened_user' => 'Du hast Wörter in <a href="https://dashboard.witty.works/user<a href="https://dashboard.witty.works/team/language/dictionary" target="_blank"><a href="https://dashboard.witty.works/user/language/dictionary" target="_blank">/language/dictionary" target="_blank">dein Team-Wörterbuch</a> eingetragen, aber während dem Zeitbereich hast Du diese Begriffe nicht verwendet .',
    'help' => 'Hilfe',
    'witty_editor_description' => 'Sollte Witty auf einer Website nicht funktionieren, kopiere einfach deinen Text und füge ihn hier zur Prüfung ein.',
...
',
    ...
    'witty_editor_example_text' => '<h2>Die Grundlagen</h2><h4> Witty hebt Sprache, die unbewusste Voreingenommenheit enthält, in Orange hervor:</h4><br><br> <em>Hallo Leute,<br> Wir haben ein großes Softwareprojekt, dessen Fertigstellung mehrere Arbeitsstunden in Anspruch nehmen wird. Wer möchte bei uns mitmachen? Bringen Sie Ihr außergewöhnliches Fachwissen und Ihren starken technischen Hintergrund mit. Wir sind auch auf der Suche nach einem Digital Native.</em><br><br> <em>PS Eure Frauen sind bei der Weihnachtsfeier des Vorstandes herzlich willkommen.</em><br><br><h4> Witty hebt positive Begriffe grün hervor:</h4><br> <em>Wir sind ein kreatives Team.</em><br><br><h4> Witty hebt Grammatik- und Rechtschreibfehler rot hervor:</h4><br> <em>Das ist ein Rechtschreibefehler.</em><h2> Wo Witty arbeitet</h2><p> Witty funktioniert auf <a href="https://www.witty.works/witty-works-where-you-do" rel="noopener" target="_blank" style="color: rgb(85, 184, 233);">den meisten Webseiten</a>, auf denen Du schreibst. Witty wird automatisch aktiviert. Für Microsoft Word, verwende das <a href="https://appsource.microsoft.com/de-de/product/office/wa200006592?tab=overview" rel="noopener" target="_blank" style="color: rgb(85, 184, 233);">Witty for Word</a> Add-in. Wenn Du andere Microsoft-Produkte verwendest, nutze stattdessen unseren <a href="http://dashboard.witty.works/editor" rel="noopener" target="_blank" style="color: rgb(85, 184, 233);">Editor</a>. </p><div><img src="https://www.witty.works/hubfs/Screenshot%202023-03-16%20at%2016.15.39.png" alt="Logo von Google Docs, Notion, Gmail, LinkedIn, Personio und Gewächshaus" style="width:100%; padding:top:20px"></div>',
...
Bitte gehe dann erneut auf „Registrieren“, um die Registrierung im "Witty for Word" Add-in abzuschließen.',
    ...
    'chart_period_comparison_from' => 'Vergleiche Zeitbereich:',
    'chart_period_comparison_to' => 'zu dem Zeitbereich:',
    'inclusive_filter' => 'Inklusion',
    ...
    'personal_account_content' => 'persönliche Einstellungen',
    'team_account_content_aria_label' => 'Team Einstellungen',
    'desktop_navigation' => 'Desktop-Navigation',
    'toggle_mobile_navigation' => 'Handynavigation öffnen/schliessen',
    'mobile_navigation' => 'Handy Navigation',
    'office_register' => 'Microsoft Office Dashboard-Registrierung',
    'has_consented_to_terms_of_service' => 'Akzeptiere die Allgemeinen Geschäftsbedingungen',
    'has_consented_to_mailing' => 'Erhalten die Produktmailings',
    'already_registered_with_a_different_email_title' => 'Bereits registriert?',
    'already_registered_with_a_different_email_description' => 'Stelle  sicher, dass Deine Microsoft Office-E-Mail-Adresse mit der E-Mail-Adresse übereinstimmt, welche Du für Dein bestehenden Konto verwendst.',
    'office_register_title' => 'Privatsphäre, Datenschutz und Sicherheit',
    'office_register_description' => 'Wir gehen bei diesem Thema sehr streng vor und gehen über die Branchenstandards hinaus. <strong>Witty Works stellt Ethik an die erste Stelle.</strong> Das Vertrauen unserer Nutzer ist uns wichtiger als die Datenerhebung.',
    'office_register_summary' => 'Kurzgesagt:<ul><li>Wir trennen das Benutzerprofil (wie E-Mail usw.) vollständig von den erfassten Daten, sodass <strong>wir in unseren Analysen beispielsweise nicht nachvollziehen können, wer welchen Text geschrieben hat.</strong></li><li> Wir speichern nur einen sehr begrenzten Teil Deiner Texte <strong>zum Zweck der Produktverbesserung</strong> (z. B. was hervorgehoben werden soll, welche Alternativen angezeigt werden sollen).</li><li>In der kostenpflichtigen Version kannst Du diese Art der Datenerfassung sogar deaktivieren.</li><li> Eine Weitergabe der Daten an Dritte erfolgt nicht.</li><li> <strong>Unsere Server befinden sich in der EU.</strong></li></ul>',
    ...
    'no' => 'nein',
    'role' => 'Rolle',
    'on-trial_title' => 'Bereit, ein Abo abzuschließen?',
    'on-trial_text' => 'Dein Team befindet sich derzeit in der Testphase.',
    'subscription-ended_title' => 'Abonnement beendet',
