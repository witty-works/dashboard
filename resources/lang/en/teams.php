...
return [
    ...
    'plan_headline' => 'Your Subscription',
    'profile' => 'Profile',
    ...
    'term_replacements' => 'Team dictionary words',
    ...
    'user_licenses_count_will_be_increased_updated_at' => '{1} One user license will be added in :dateDiff | :diff user licenses will be added in :dateDiff',
    'user_licenses_count_will_be_decreased_updated_at' => '{1} One user license will be removed in :dateDiff | :diff user licenses will be removed in :dateDiff',
