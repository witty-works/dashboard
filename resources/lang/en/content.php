...
<div><img src="https://www.witty.works/hubfs/Screenshot%202023-03-16%20at%2016.15.39.png" alt="Logo of Google Docs, Notion, Gmail, LinkedIn, Personio and greenhouse" style="width:100%; padding:top:20px" ></div>',
    ...
    'footer_aria_label' => 'footer aria label',
    'language_switcher_aria_label' => 'language switcher aria label',
    'skip_to_main_content' => 'skip to main content',
    'witty_logo_alt' => 'witty logo alt',
    'main_navigation_aria_label' => 'main navigation aria label',
    'personal_account_content' => 'personal account content',
    'manage_account_alt' => 'manage account alt',
    'analytics_alt' => 'analytics alt',
    'language_settings_alt' => 'language settings alt',
    'team_account_content_aria_label' => 'team account content aria label',
    'manage_team_alt' => 'manage team alt',
    'subscription_alt' => 'subscription alt',
    'witty_editor_alt' => 'witty editor alt',
    'academy_alt' => 'academy alt',
    'log_out_alt' => 'log out alt',
    'pricing_alt' => 'pricing alt',
    'log_in_alt' => 'log in alt',
    'register_alt' => 'register alt',
    'save_aria_label' => 'save aria label',
    'cancel_aria_label' => 'cancel aria label',
    'update_your_account_profile_aria_label' => 'update your account profile aria label',
    'mailing_consent_button_aria_label' => 'mailing consent button aria label',
];
