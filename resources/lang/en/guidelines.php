...
only the gender ending (e.g. "Mitarbeiter*in"), the female and male form (e.g. "Mitarbeiterin oder Mitarbeiter"), both or gender-neutral alternatives such as "Mitarbeitende".',
    ...
    'case_insensitive_long' => 'Case-Insensitive (i.e. "Witty" would also match "witty" or "WITTY")',
    'case_sensitive_long' => 'Case-Sensitive (i.e. "Witty" would only match exactly "Witty" but not "witty" or "WITTY")',
    'lemmatize_long' => 'Lemmatize (i.e. "running" will be converted to "run" to then also match "ran" etc. and adjust alternatives as well")',
    'case_insensitive' => 'Case-Insensitive',
    'case_sensitive' => 'Case-Sensitive',
    'lemmatize' => 'Lemmatize',
    'lemmatize_requires_single_word' => 'Lemmatization of phrases is not supported, use a single word',
    'lemmatize_requires_language_code' => 'Lemmatization requires choosing a specific language',
    'lemmatization_error' => 'Unable to lemmatize term, please try again later or choose a different term',
    'matching_type_label' => 'Matching',
    'adjective_long' => 'Adjective (f.e. "honest")',
    'verb_long' => 'Verb (f.e. "running")',
    'substantive_long' => 'Noun (f.e. "office")',
    'a' => 'Adjectives',
    'v' => 'Verbs',
    's' => 'Nouns',
