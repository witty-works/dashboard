...
LLM are also used for Witty GPT, our solution for GenerativeAI that produces more inclusive content. Witty GPT monitors your promts for bias and makes sure that the language used in the result is inclusive.',
    ...
    'french_gender_separator_point_median' => 'Point médian, f.e. expert·es',
    'french_gender_separator_point_median_s' => 'Point médian, incl. plural, f.e. expert·e·s',
    'french_gender_separator_point' => 'Point, f.e. expert.es',
    'french_gender_separator_point_s' => 'Dot incl. plural, f.e. expert.e.s',
    'french_gender_separator_barre_oblique' => 'Slash, f.e. expert/es',
    'french_gender_separator_barre_oblique_s' => 'Slash, incl. plural, f.e. expert/e/s',
    'germam_gender_separator_genderstar' => 'Genderstar, f.e Expert*in',
    'germam_gender_separator_colon' => 'Colon, f.e Expert:in',
    'germam_gender_separator_gendergap' => 'Gendergap, f.e Expert_in',
    ...
    'german_gender_ending_label' => 'Gender ending',
    'french_gender_separator_label' => 'Gender separator',
];
