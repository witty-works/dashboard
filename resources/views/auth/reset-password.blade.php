    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="block">
                ...
                <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" @error('email') aria-invalid="true" aria-describedby="email-error" @enderror />
            </div>
