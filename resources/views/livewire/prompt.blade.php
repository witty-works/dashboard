        ...
        <div class="align-middle items-center" wire:loading.remove>
            <h2 class="mt-5 flex">
                ...
                <div class="relative pl-50 flex items-center">
                    <button onclick="copyToClipboard(); return false;" alt="{{ __('content.copy_to_clipboard')}}" class="flex items-center justify-center h-8 text-xs bg-white border rounded-md cursor-pointer w-9 border-neutral-200/60 hover:bg-neutral-100 active:bg-white focus:bg-white focus:outline-none text-neutral-500 hover:text-neutral-600 group">
